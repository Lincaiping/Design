...
<div class="mainindex">
    ...
    <ul class="iconlist">
        ...
        <li><img src="/images/manage/ico01.png"/>
            <p><a href="#">管理信息</a></p></li>
        <li><img src="/images/manage/ico02.png"/>
            <p><a href="#">其他管理</a></p></li>
        <li><img src="/images/manage/ico03.png"/>
            <p><a href="#">常用工具</a></p></li>
        <li><img src="/images/manage/ico04.png"/>
            <p><a href="#">文件上传</a></p></li>
        <li><img src="/images/manage/ico05.png"/>
            <p><a href="#">目录管理</a></p></li>
        <li><img src="/images/manage/ico06.png"/>
            <p><a href="#">退出</a></p></li>
