...
<div class="wrap100 topNav">
    <ul>
        ...
        <li><img src="/images/personal/jt1.jpg" height="79"/></li>
        <li class="bg2"><a href="${ctx}/faWap/personalCenter!account.action">我的账户</a></li>
        <li><img src="/images/personal/jt2.jpg" height="79"/></li>
        <li class="bg3"><a href="javascript:problem()">意见反馈</a></li>
        <li><img src="/images/personal/jt3.jpg" height="79"/></li>
    </ul>
</div>
<!--导航 end-->
...
<div class="waiceng">
    <textarea id="view" class="textarea" rows="5" name="content"
              placeholder="请填写您在使用过程中遇到的问题和建议，感谢您的支持，谢谢。"></textarea>
    ...
    邮&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp箱：<input id="email" name="eamil" class="input"
                                                 value="${email }" type="text"/><br/>
    <button id="submit" class="button" type="submit" onclick="submit()">提&nbsp&nbsp&nbsp&nbsp交
    </button>
</div>

<div class="delf-wrap" id="div_mod" style="display: none;">
    <div class="ui-form" style="text-align: center;font-size:23px;color:#767676;">
        <img src="/images/personal/sucess.png" width="191" style="margin-top: 20px;"><br/>
        <div style="padding: 10px;">已成功提交，您的建议将是我们努力<br/>的方向！谢谢</div>
        <div class="btn-wrap">
            <button id="submit_button" class="button" type="submit" onclick="confirm()"
                    style="width: 90%;margin-bottom: 20px;">确&nbsp&nbsp&nbsp&nbsp认
            </button>
            <br/>
        </div>
    </div>
